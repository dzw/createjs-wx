...
// symbols:
    ...
    (lib.daojishi = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(179).to({_off: false}, 0).to({
            scaleX: 1,
            scaleY: 1
        }, 40).to({alpha: 0}, 21).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).to({
            scaleX: 1,
            scaleY: 1
        }, 39).to({alpha: 0}, 20).to({_off: true}, 1).wait(181));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off: false}, 0).to({
            scaleX: 1,
            scaleY: 1
        }, 40).to({alpha: 0}, 20).to({_off: true}, 1).wait(121));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(119).to({_off: false}, 0).to({
            scaleX: 1,
            scaleY: 1
        }, 40).to({alpha: 0}, 20).to({_off: true}, 1).wait(61));
    ...
    (lib.carAssets4 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off: false}, 0).to({
            regX: 129.9,
            scaleX: 3.24,
            scaleY: 3.24,
            x: 5.7,
            alpha: 0
        }, 8).to({_off: true}, 1).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).to({
            ...
            x: -7,
            y: -49.5
        }, 3).to({rotation: 28.7, x: 23, y: -80.5}, 3).to({
            rotation: -7,
            x: -8,
            y: -101.5
        }, 3).to({_off: true}, 1).wait(11));
    ...
    (lib.carAssets3 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).to({
            ...
            x: -5.5,
            y: -24.5
        }, 3).to({rotation: 19.5, x: 15.4, y: -47.5}, 3).to({
            rotation: -8.7,
            x: 0.5,
            y: -80.4
        }, 3).to({_off: true}, 1).wait(11));
    ...
    (lib.carAssets2 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).to({
            ...
            x: -8.5,
            y: -32.5
        }, 3).to({rotation: 9.2, x: 7.1, y: -54.6}, 3).to({rotation: -2.2, x: -14.7, y: -71.5}, 3).to({
            rotation: 1.2,
            x: -0.4,
            y: -111.5
        }, 3).to({_off: true}, 1).wait(8));
    ...
    (lib.carAssets1 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(41).to({_off: false}, 0).wait(4).to({
            regY: 117.1,
            rotation: 39.7,
            x: -20,
            y: 16
        }, 0).wait(4).to({regY: 117, rotation: 94.7, y: -2}, 0).wait(4).to({
            rotation: 146.9,
            x: -18.9,
            y: -16
        }, 0).wait(4).to({regX: 79.6, rotation: 206.9, x: 7.1, y: -17}, 0).wait(4).to({
            rotation: 259.4,
            x: 17.1,
            y: 0
        }, 0).wait(4).to({regX: 79.7, rotation: 311.4, x: 11.2, y: 16.9}, 0).wait(4).to({
            regY: 117.1,
            rotation: 352.1,
            x: 0.2,
            y: 20
        }, 0).wait(4).to({rotation: 392.9, x: -13.8}, 0).wait(4).to({
            regX: 79.6,
            rotation: 434.1,
            x: -23.8,
            y: 0.9
        }, 0).wait(4).to({regX: 79.5, rotation: 444.7, x: -29.9, y: -11.1}, 0).wait(4).to({
            regY: 117.2,
            rotation: 449.4,
            x: -32.9
        }, 0).wait(4).to({regX: 79.6, rotation: 454.1, x: -36.9, y: -17}, 0).wait(4));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(28).to({_off: false}, 0).to({
            scaleX: 3.08,
            scaleY: 1.71,
            y: -77.3
        }, 2).to({regX: 232, scaleX: 2.03, scaleY: 2.23, y: -77}, 2).to({
            regX: 232.1,
            scaleX: 3,
            y: -77.2
        }, 2).to({scaleX: 2.42, scaleY: 1.53, x: -3.7}, 2).to({
            regX: 232,
            scaleX: 2.06,
            scaleY: 2.23,
            x: -3.6,
            y: -93.7
        }, 2).to({regX: 232.1, scaleX: 2.42, y: -77.2}, 2).to({_off: true}, 1).wait(52));
        this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(41).to({_off: false}, 0).wait(4).to({
            regY: 21.9,
            rotation: 52.7,
            x: 10.1,
            y: -25
        }, 0).wait(4).to({rotation: 118.2, x: 20.1, y: -40}, 0).wait(4).to({
            rotation: 138.4,
            x: 23.1,
            y: -46
        }, 0).wait(4).to({regY: 22, rotation: 154.4, x: 28.1, y: -52.1}, 0).wait(4).to({
            regY: 21.9,
            rotation: 170.9,
            x: 31.1,
            y: -58
        }, 0).wait(4).to({rotation: 185.3, x: 34.1, y: -64}, 0).wait(28));
